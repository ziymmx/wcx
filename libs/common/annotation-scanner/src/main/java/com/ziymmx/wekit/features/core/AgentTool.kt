...
/**
 * Marks a function as a WeAgent built-in tool. The [com.ziymmx.wekit.features.AgentToolScanner] KSP processor
 ...
 * so no hand-written mapping table is needed and new [com.ziymmx.wekit] APIs are picked up
