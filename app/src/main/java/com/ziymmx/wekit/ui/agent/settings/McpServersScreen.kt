...
private val MCP_MODE_ORDER = listOf(
    com.ziymmx.wekit.agent.tool.ToolMode.ENABLED,
    com.ziymmx.wekit.agent.tool.ToolMode.MANUAL_APPROVAL,
    com.ziymmx.wekit.agent.tool.ToolMode.SMART_APPROVAL,
    com.ziymmx.wekit.agent.tool.ToolMode.DISABLED,
)

private fun com.ziymmx.wekit.agent.tool.ToolMode.mcpLabel(): String = when (this) {
    com.ziymmx.wekit.agent.tool.ToolMode.ENABLED -> "直接允许"
    com.ziymmx.wekit.agent.tool.ToolMode.MANUAL_APPROVAL -> "手动审批"
    com.ziymmx.wekit.agent.tool.ToolMode.SMART_APPROVAL -> "智能审批"
    com.ziymmx.wekit.agent.tool.ToolMode.DISABLED -> "禁用"
}

@Composable
private fun McpToolModeDropdown(name: String, mode: com.ziymmx.wekit.agent.tool.ToolMode, onChange: (com.ziymmx.wekit.agent.tool.ToolMode) -> Unit) {
