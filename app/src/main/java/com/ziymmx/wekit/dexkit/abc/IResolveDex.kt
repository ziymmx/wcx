package com.ziymmx.wekit.dexkit.abc
 ...
 *
 * 实现类通过 [com.ziymmx.wekit.dexkit.dsl.dexClass] / [com.ziymmx.wekit.dexkit.dsl.dexMethod] / [com.ziymmx.wekit.dexkit.dsl.dexConstructor] 工厂函数声明委托属性，
...
interface IResolveDex {
     ...
     * 供 [com.ziymmx.wekit.dexkit.cache.DexCacheManager] 持久化。
     */
