...
import com.ziymmx.wekit.agent.data.WeAgentSettings.load
...
object WeAgentSettings {
    ...
    suspend fun sendWhileRunningMode(): com.ziymmx.wekit.features.api.agent.WeAgentService.SendWhileRunningMode =
        when (get(KEY_SEND_WHILE_RUNNING)) {
            "QUEUE_AS_STEER" -> com.ziymmx.wekit.features.api.agent.WeAgentService.SendWhileRunningMode.QUEUE_AS_STEER
            else -> com.ziymmx.wekit.features.api.agent.WeAgentService.SendWhileRunningMode.QUEUE_AFTER_TURN
        }
}
