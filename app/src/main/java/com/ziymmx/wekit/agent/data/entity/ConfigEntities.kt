...
data class ModelEntity(
     ...
     * [com.ziymmx.wekit.agent.tool.BuiltinToolProvider.visionToolsVisible]). Sending images to a
 ...
 * Keys are stored as-is; see [com.ziymmx.wekit.agent.net.ExternalServiceId] for known ids.
 */
