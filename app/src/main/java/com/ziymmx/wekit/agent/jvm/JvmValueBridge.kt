package com.ziymmx.wekit.agent.jvm
...
import com.ziymmx.wekit.utils.reflection.byte
import com.ziymmx.wekit.utils.reflection.char
import com.ziymmx.wekit.utils.reflection.double
...
import com.ziymmx.wekit.utils.reflection.short
 ...
 * argument is a self-describing `kind:payload` **token** (see [com.ziymmx.wekit.agent.jvm.JvmValueBridge.parseValue]); every result is
 * rendered back either inline (primitives/strings/null) or as a freshly-minted handle
 * (see [com.ziymmx.wekit.agent.jvm.JvmValueBridge.render]).
 *
