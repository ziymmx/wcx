...
import com.ziymmx.wekit.features.items.system.servers.WeChatService
import com.ziymmx.wekit.features.items.system.servers.WeChatService.Result

/**
 * The built-in WeAgent tool surface. Every `@AgentTool` function here is discovered by the
 * [com.ziymmx.wekit.features.AgentToolScanner] KSP processor and registered in the generated
