...
import com.ziymmx.wekit.agent.ui.UiAutomator
...
object WeUiAutomationToolBindings {
    ...
    fun uiInputText(
        ...
        JvmValueBridge.onMain {
            val act = com.ziymmx.wekit.utils.android.getTopMostActivity()
                ?: throw com.ziymmx.wekit.agent.jvm.JvmBridgeException("No top-most activity")
            val focused = act.currentFocus
                ?: throw com.ziymmx.wekit.agent.jvm.JvmBridgeException("No focused view")
