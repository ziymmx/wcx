...
import com.ziymmx.wekit.features.api.core.models.WeMessage
...
object WeDatabaseApi : ApiFeature(), IResolveDex {
     ...
     */
    fun getChatroomSyncState(roomId: String): com.ziymmx.wekit.features.api.core.models.ChatroomSyncStateReadResult {
        if (roomId.isEmpty()) return com.ziymmx.wekit.features.api.core.models.ChatroomSyncStateReadResult.Unavailable
        return try {
            val rows = executeQuery(
                "SELECT memberlist, chatroomVersion FROM chatroom WHERE chatroomname = ?",
                arrayOf(roomId as Any),
            )
            if (rows.isEmpty()) com.ziymmx.wekit.features.api.core.models.ChatroomSyncStateReadResult.MissingRow
            else com.ziymmx.wekit.features.api.core.models.ChatroomSyncStateReadResult.Available(
                com.ziymmx.wekit.features.api.core.models.WeChatroomSyncState(
                    roomId = roomId,
            ...
            com.ziymmx.wekit.features.api.core.models.ChatroomSyncStateReadResult.Unavailable
        }
    }
}
